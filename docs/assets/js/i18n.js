(function (global) {
  ...
  const messages = {
    en: {
      ...
      'guides.projects.step7': 'Sprint planning: pick tasks → Iteration Sprint 1 → Status To Do (only after issues exist).',
    ...
    es: {
      ...
      'guides.projects.step7': 'Sprint planning: elegí tasks → Iteration Sprint 1 → Status To Do (solo cuando ya hay issues).',
