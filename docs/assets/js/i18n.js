(function (global) {
  ...
  const messages = {
    en: {
      ...
      'guides.projects.step5': 'New issue → choose Epic / User Story / QA Task templates, or copy from SEED_ISSUES.md.',
      'guides.projects.step6': 'Add issues to the project; practice a 1-week sprint moving AC tasks to Done with evidence.',
    ...
    es: {
      ...
      'guides.projects.step5': 'New issue → plantillas Epic / User Story / QA Task, o copiá desde SEED_ISSUES.md.',
      'guides.projects.step6': 'Agregá issues al project; practicá un sprint de 1 semana moviendo tasks AC a Done con evidencia.',
