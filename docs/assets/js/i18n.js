(function (global) {
  ...
  const messages = {
    en: {
      ...
      'meta.desc.home': 'GGZenLab — Software Quality Analyst & Test Automation Engineer. Hands-on QA portfolio with AI-assisted design and documentation; validation driven by QA discipline.',
      'nav.home': 'Home',
      'nav.api': 'API Testing',
      ...
      'hero.subtitle': 'GGZenLab hands-on monorepo — built and documented with AI assistance (design, scaffolding, and review). Acceptance criteria, testing, and validation driven by QA discipline: Gherkin stories, manual and automated cases, evidence reports, and contract-first APIs.',
      ...
      'backlog.agile.desc': 'GitHub Projects board: epics, stories from Gherkin, QA tasks, sprint practice — integrated with this repo.',
    ...
    es: {
      ...
      'meta.desc.home': 'GGZenLab — Analista de Calidad e Ingeniería en Automatización de Pruebas. Portfolio hands-on con diseño y documentación asistidos por IA; validación bajo enfoque QA.',
      'nav.home': 'Inicio',
      'nav.api': 'API Testing',
      'nav.perf': 'Performance',
      'nav.guides': 'Práctica',
      ...
      'hero.subtitle': 'Monorepo hands-on de GGZenLab — desarrollado y documentado con asistencia de IA (diseño, scaffolding y revisión). Criterios de aceptación, pruebas y validación bajo enfoque QA: historias Gherkin, casos manuales y automatizados, reportes con evidencias y APIs contract-first.',
      ...
      'backlog.agile.desc': 'Tablero GitHub Projects: epics, stories desde Gherkin, tasks QA, práctica de sprint — integrado al repo.',
